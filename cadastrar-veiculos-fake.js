...
// Execute: node cadastrar-veiculos-fake.js

const { createClient } = require('@supabase/supabase-js');

// Configurações do Supabase
const supabaseUrl = 'https://ecdmpndeunbzhaihabvi.supabase.co';
const supabaseKey = 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImVjZG1wbmRldW5iemhhaWhhYnZpIiwicm9sZSI6ImFub24iLCJpYXQiOjE3MzE2OTY4NzAsImV4cCI6MjA0NzI3Mjg3MH0.4z_bNuLaVhBHWUUJUDNGOIGhWJBBBBBBBBBBBBBBBBB';

const supabase = createClient(supabaseUrl, supabaseKey);

// Lista dos 15 veículos
const veiculos = [
  {
